...
RSpec.describe Comment, type: :model do
  it 'adds a comment' do
    ...
    post = Post.new(title: 'New test post', text: 'Hello', author_id:, likesCounter: 0, commentsCounter: 0)
    post.save!

    comment_creator = User.new(name: 'Jerry', photo: 'pic.jpeg', bio: 'Bio for user', postsCounter: 0)
    comment_creator.save!

    post.comments.create!(text: 'Hello', author_id: comment_creator)
    post.comments.create!(text: 'second post', author_id: comment_creator)
